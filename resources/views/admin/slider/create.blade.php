            ...
            <div class="card-body mt-4">
              <form action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="{{ old('title') }}" class="form-control"placeholder="Enter Slider Title"
                      name="title" id="name" />
                    @error('title')
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="{{ old('title') }}" class="form-control"placeholder="Enter Slider Url"
                      name="url" id="name" />
                    @error('url')
                      <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="file" data-default-file="{{ old('image') }}" class="form-control dropify"
                ...
                <div class="mb-3 row ecommerce-select2-dropdown">
                  <div class="col-sm-2">
                    <label class="form-label mb-1 d-flex justify-content-between align-items-center" for="category-org">
                      <span>Product Status <span class="text-warning">(default: Active)</span></span>
                    </label>
                  </div>
                  <div class="col-sm-10">
